...
const Header = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center my-20">
      ...
      <button className="flex mt-8 text-white bg-black rounded-full px-12 py-3 hover:scale-105 transition-all duration-500 cursor-pointer gap-2 w-auto items-center">
        ...
        {Array(6)
          ...
          .map((_, index) => (
            <img
              ...
              key={index}
              width={70}
              className="rounded hover:scale-105 transition-all duration-300 max-sm:w-10 cursor-pointer"
            />
          ))}
      </div>
